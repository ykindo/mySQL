...
CREATE TABLE `tbl_user` (
  ...
  `user_administrateur` bit(1) DEFAULT NULL,
  `user_civilite` varchar(50) DEFAULT NULL,
  `user_titre` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tbl_infoemploye` (
  ...
  `info_indemniteFonction` float DEFAULT NULL,
  `info_indemniteTransport` float DEFAULT NULL,
  `info_indemniteSujetion` float DEFAULT NULL,
  `info_indemniteTechnicite` float DEFAULT NULL COMMENT 'Indemnité de technicité',
  `info_indemniteCaisse` float DEFAULT NULL,
  `info_indemniteAutres` float DEFAULT NULL,
  `info_autresPrimes` float DEFAULT NULL,
  `info_avantagesNatureImmobilisation` float DEFAULT NULL,
  `info_avantagesNatureEmploye` float DEFAULT NULL COMMENT 'Salaire de base de l''employé mis à disposition',
  `info_allocationFamilliale` float DEFAULT NULL,
  `info_montantHeuresSupplementaires` float DEFAULT NULL,
  `info_avanceAcompte` float DEFAULT NULL,
  `info_oppositionSaisieArret` float DEFAULT NULL,
  `info_autresRetenues` float DEFAULT NULL,
  `info_chargeFamilial` smallint DEFAULT NULL,
...
CREATE TABLE `informationemplofincontrat` (
  ...
  `TauxSalaireJournalier` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `salairebaseheure` (
  ...
  `Taux horaire normale` float DEFAULT NULL,
  `Nombre d'heures normales semaine 1` float DEFAULT NULL,
  `Nombre d'heures normales semaine 2` float DEFAULT NULL,
  `Nombre d'heures normales semaine 3` float DEFAULT NULL,
  `Nombre d'heures normales semaine 4` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours ouvrés 1` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours ouvrés 2` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours ouvrés 3` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours ouvrés 4` float DEFAULT NULL,
  `Nombre d'heures de jour pendant les jours non ouvrés 1` float DEFAULT NULL,
  `Nombre d'heures de jour pendant les jours non ouvrés 2` float DEFAULT NULL,
  `Nombre d'heures de jour pendant les jours non ouvrés 3` float DEFAULT NULL,
  `Nombre d'heures de jour pendant les jours non ouvrés 4` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours non ouvrés 1` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours non ouvrés 2` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours non ouvrés 3` float DEFAULT NULL,
  `Nombre d'heures de nuit pendant les jours non ouvrés 4` float DEFAULT NULL,
  `Montant pour heures normales S1 Sup0` double DEFAULT NULL,
  `Montant pour heures normales S1 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S1 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S1` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S2 Sup0` double DEFAULT NULL,
  `Montant pour heures normales S2 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S2 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S3 Sup0` double DEFAULT NULL,
  `Montant pour heures normales S3 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S3 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S3` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S4 Sup0` double DEFAULT NULL,
  `Montant pour heures normales S4 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S4 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales S4` decimal(10,0) DEFAULT NULL,
  `Montant pour heures normales` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S1 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S1 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S2 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S2 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S3 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S3 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S4 Sup1` decimal(10,0) DEFAULT NULL,
  `Montant supplémentaire pour heures normales S4 Sup2` decimal(10,0) DEFAULT NULL,
  `Montant pour heures supplémentaires normales` decimal(10,0) DEFAULT NULL,
  `Montant pour heures supplémentaires non ouvrées` decimal(10,0) DEFAULT NULL,
  `Montant total pour heures supplémentaires` decimal(10,0) DEFAULT NULL,
  `Salaire de base` decimal(10,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
